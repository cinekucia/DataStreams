...
from Smart_ARF_V2 import SmartARF_V2
...
def run_evaluation(arff_file_path: str, output_dir: str, \
    ...
    """
    Run a probability-aware prequential evaluation on a single ARFF file using SmartARF,
    ...
    arf = SmartARF_V2(
        ...
        hoeffding_delta_prune=0.01,
        min_samples_for_hoeffding=100,
        pruning_strategy_at_capacity="min_instances_then_hoeffding",
        n_models=10,
        seed=42,
...
if __name__ == "__main__":
    ...
    if all_metrics:
        ...
        combined_csv = os.path.join(output_dir, f"metrics_SMARTARFV2_all_streams.csv")
