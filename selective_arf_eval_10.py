...
def run_evaluation(arff_file_path: str, output_dir: str, \
    ...
    river_model = SelectiveARFClassifier(
        n_models=10, 
        seed=42,
        prediction_confidence_threshold=0.1, # Note: Corrected comma to dot
...
if __name__ == "__main__":
    ...
    output_dir = "./SelectiveARF_t0.1_FINAL"
    ...
    if all_metrics:
        ...
        combined_csv = os.path.join(output_dir, f"metrics_SelectiveARF_t0.1_all_streams.csv")
